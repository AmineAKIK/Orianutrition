...
export function AboutPage() {
  ...
  return <>
    ...
    <section className="bg-forest-dark text-paper section-pad"><Container><div className="max-w-2xl"><h2 className="text-paper text-3xl md:text-4xl">{signature.title}</h2><p className="mt-6 text-sage text-lg leading-relaxed">{signature.body}</p><div className="mt-9"><LinkButton to="/accompagnements">Découvrir les accompagnements <ArrowRight size={16} aria-hidden="true" /></LinkButton></div></div></Container></section>
  </>
}
