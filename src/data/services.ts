...
export const servicePacks: ServicePack[] = [
  {
    ...
    markers: ['Analyse d’une semaine type', 'Repères prioritaires personnalisés', 'Synthèse écrite après le rendez-vous'],
  },
  {
    ...
    markers: ['Bilan initial', '2 rendez-vous de suivi', 'Ajustements entre les séances', 'Ressources pratiques ciblées'],
    featured: true,
  },
  {
    ...
    markers: ['Bilan initial', '4 rendez-vous de suivi', 'Planification par séquences de travail', 'Bilan d’autonomie final'],
  },
]

export const serviceSteps = [
  ['Appel découverte', 'Clarifier le contexte et choisir un format adapté sans surdimensionner le suivi.'],
  ['Bilan initial', 'Observer le planning réel, les habitudes et les contraintes avant de proposer des ajustements.'],
  ['Expérimentation', 'Tester quelques repères simples sur plusieurs cycles de travail et noter ce qui fonctionne.'],
  ['Autonomie progressive', 'Conserver une méthode pour ajuster les repères lorsque les horaires évoluent.'],
] as const
