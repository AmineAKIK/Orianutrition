...
export const situations = [
  ...
  ['Énergie irrégulière', 'Repérer les moments difficiles et réduire les décisions prises sous fatigue.'],
  ['Repas difficiles à organiser', 'Prévoir des solutions simples quand les horaires compliquent la préparation.'],
  ['Sommeil décalé', 'Créer une routine réaliste autour du repos en journée ou entre deux rotations.'],
  ['Charge mentale', 'Avancer avec quelques repères souples plutôt qu’un cadre impossible à tenir.'],
] as const
...
export const approach = {
  ...
  principles: [
    ['Approche concrète', 'Des ajustements reliés au planning et aux contraintes observées.'],
    ['Horaires atypiques', 'Nuit, rotations, horaires matinaux ou variables.'],
    ['Sans rigidité', 'Des repères suffisamment souples pour rester utilisables.'],
    ['Autonomie', 'Comprendre ses leviers pour pouvoir ajuster ensuite sans dépendre d’un plan figé.'],
  ] as const,
  photoBadge: 'Écoute · Observation · Ajustement',
} as const

export const signature = {
  title: 'Quand ton rythme change, tes repères doivent pouvoir bouger avec lui.',
  body:
    'Oria part de l’emploi du temps réel plutôt que d’un rythme idéal. L’objectif n’est pas de tout contrôler, mais de construire une structure assez claire pour rester utile lorsque les horaires tournent.',
} as const
