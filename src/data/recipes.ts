...
export const recipes: Recipe[] = [
  {
    ...
    difficulty: "Facile",
    excerpt:
      "Une base complète qui se prépare en avance et s’assemble rapidement avant un poste.",
    description:
    ...
    steps: [
      "Préchauffer le four à 200 °C et couper la courge en cubes.",
      "Rôtir la courge avec l’huile et le paprika pendant environ 25 minutes.",
      "Cuire le quinoa puis l’égoutter.",
      "Rincer les pois chiches et préparer les jeunes pousses.",
      "Répartir les éléments dans deux bols et ajouter le citron au moment de manger.",
    ],
  },
  {
    ...
    difficulty: "Facile",
    excerpt:
      "Une option chaude et douce pour démarrer une journée ou prendre un repas léger avant un poste.",
    description:
      "Une base de flocons d’avoine simple à adapter selon les fruits disponibles et le moment où elle est consommée.",
    ingredients: [
      "50 g de flocons d’avoine",
      "220 ml de lait ou boisson végétale",
      "1/2 pomme",
    ...
    steps: [
      "Verser les flocons et le liquide dans une petite casserole.",
      "Cuire à feu doux 5 à 7 minutes en remuant.",
      "Ajouter la pomme en dés pendant les deux dernières minutes.",
      "Servir avec la purée d’amande, les graines et une pincée de cannelle.",
    ],
  },
  {
    ...
    difficulty: "Facile",
    excerpt:
      "Un repas compact qui s’emporte facilement quand la pause est courte ou imprévisible.",
    description:
    ...
    steps: [
      "Mélanger le yaourt, la moutarde, les herbes et le poivre.",
      "Tailler les crudités en fines lamelles.",
      "Répartir la sauce, la salade, le poulet et les crudités sur les tortillas.",
      "Rabattre les côtés puis rouler fermement.",
      "Conserver au frais jusqu’au repas.",
    ],
  },
  {
    ...
    difficulty: "Facile",
    excerpt:
      "Une salade qui se conserve bien et évite de dépendre d’un micro-ondes pendant la pause.",
    description:
    ...
    steps: [
      ...
      "Couper la tomate, le concombre et la feta.",
      "Ciseler les herbes.",
      "Mélanger tous les ingrédients.",
      "Ajouter l’huile et le citron juste avant de servir.",
    ],
  },
  {
    ...
    difficulty: "Facile",
    excerpt:
      "Une assiette minute pour les jours où cuisiner longtemps n’est pas réaliste.",
    description:
    ...
    steps: [
      "Cuire l’œuf selon la texture souhaitée.",
      "Faire griller le pain.",
      "Étaler le houmous.",
      "Ajouter les légumes puis l’œuf coupé.",
      "Terminer avec le sésame et le poivre.",
    ],
  },
  {
    ...
    difficulty: "Facile",
    excerpt:
      "Une collation simple à assembler pour éviter de partir travailler sans option prévue.",
    description:
    ...
    steps: [
      "Verser le yaourt dans un bol ou un contenant.",
      "Couper la poire en dés.",
      "Ajouter les noix et les flocons.",
      "Saupoudrer de cacao juste avant de manger.",
    ],
  },
];
