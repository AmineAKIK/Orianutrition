...
export const articles: Article[] = [
  {
    ...
    isoDate: '2026-08-24',
    excerpt: 'Construire quelques repères stables sans essayer de reproduire artificiellement une journée classique.',
    body: [
  ...
  },
  {
    ...
    title: 'Passer d’un rythme de jour à une série de nuits : quels repères garder ?',
    category: 'Organisation',
    isoDate: '2026-08-17',
    excerpt: 'Identifier les éléments du quotidien qui peuvent rester constants quand les heures de sommeil et de repas se déplacent.',
    body: [
  ...
  },
  {
    ...
    category: 'Sommeil',
    isoDate: '2026-08-10',
    excerpt: 'Une séquence courte et répétable peut être plus utile qu’une longue routine impossible à tenir après une nuit difficile.',
    body: [
  ...
  },
  {
    ...
    title: 'Préparer des collations pour un poste long sans multiplier les options',
    category: 'Organisation',
    isoDate: '2026-08-03',
    excerpt: 'Prévoir peu d’options mais les rendre réellement disponibles peut éviter beaucoup de décisions prises sous fatigue.',
    body: [
  ...
  },
  {
    ...
    category: 'Repas',
    isoDate: '2026-07-27',
    excerpt: 'Remplacer le menu rigide par quelques préparations modulaires qui peuvent servir à plusieurs moments de la semaine.',
    body: [
  ...
  },
  {
    ...
    title: 'Observer son énergie sans transformer le quotidien en tableau de bord',
    category: 'Repères',
    isoDate: '2026-07-20',
    excerpt: 'Quelques observations simples peuvent suffire pour repérer les moments difficiles et tester des ajustements.',
    body: [
