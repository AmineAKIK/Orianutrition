    ...
    <footer className="bg-forest-dark text-paper">
      <div className="container-editorial grid gap-10 py-14 md:grid-cols-[1.2fr_1fr_1fr] lg:py-20">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-sage">
            Des repères concrets pour organiser les repas, la récupération et le
            quotidien quand les horaires changent.
          </p>
          <p className="mt-5 text-xs uppercase tracking-[.14em] text-sage/80">
            {brand.practitioner} · {brand.role}
          </p>
        </div>
        <div>
          <p className="text-xs uppercase tracking-[.18em] text-sage">
            Navigation
          </p>
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-sage">{brand.email}</p>
          <p className="mt-2 text-sm text-sage">{brand.phone}</p>
      ...
      <div className="border-t border-sage/20">
        <p className="container-editorial py-5 text-xs leading-relaxed text-sage/80">
          Projet de démonstration — marque, identité, coordonnées, prix et données
          client fictifs. Aucune donnée réelle n’est traitée.
        </p>
      </div>
    </footer>
  );
