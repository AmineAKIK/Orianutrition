...
export function PractitionerSection() {
  return <section className="section-pad"><Container><div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
    <div className="aspect-[4/5] max-w-md overflow-hidden bg-sage-light border border-sage"><img src={portrait} alt={`Portrait illustré de ${brand.practitioner}`} className="h-full w-full object-cover" loading="lazy" /></div>
