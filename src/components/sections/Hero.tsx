      ...
      <Container className="pb-12 pt-8 sm:pb-14 sm:pt-10 lg:pb-20 lg:pt-14">
        <div className="grid items-center gap-8 md:grid-cols-[minmax(0,1.08fr)_minmax(0,.92fr)] md:gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,1fr)] lg:gap-14">
          <div>
            ...
            <h1 className="text-balance font-serif text-[2.25rem] leading-[1.07] text-forest-dark sm:text-5xl md:text-[2.65rem] lg:text-[clamp(2.75rem,3.6vw,4.4rem)]">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:items-center md:flex-col md:items-stretch lg:flex-row lg:items-center">
              <LinkButton
                to="/accompagnements"
