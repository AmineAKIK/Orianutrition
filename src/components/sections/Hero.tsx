...
import portrait from '../../assets/practitioner/elise-marceau-hero.avif'
...
export function Hero() {
  return <section className="bg-paper"><Container className="pt-10 pb-14 lg:pt-14 lg:pb-20"><div className="grid lg:grid-cols-[minmax(0,1.08fr)_minmax(0,1fr)] gap-10 lg:gap-14 items-center">
    ...
    <div><div className="aspect-[4/5] max-w-xs sm:max-w-sm lg:max-w-none mx-auto overflow-hidden bg-cream border border-sage"><img src={portrait} alt="Portrait d’Élise Marceau" className="h-full w-full object-cover" width={400} height={500} fetchPriority="high" /></div><p className="mt-4 text-center lg:text-right font-serif italic text-sm text-forest-soft">« Ton rythme mérite des repères qui peuvent bouger avec lui. »</p></div>
