...
export function PWAInstallButton() {
  ...
  if (!installEvent) {
    ...
    return <button type="button" onClick={() => window.location.reload()} className="inline-flex min-h-11 items-center gap-2 text-sm font-medium text-forest-soft transition-colors hover:text-forest-dark"><RefreshCw size={16} aria-hidden="true"/>Actualiser pour réinstaller</button>
  }
